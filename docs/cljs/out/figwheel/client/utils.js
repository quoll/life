...
return (new CustomEvent(event_name,(function (){var obj41780 = {"detail":data};
return obj41780;
})()));
} else {
...
var f = (function (){var pred__41787 = cljs.core._EQ_;
var expr__41788 = (cljs.core.truth_(figwheel.client.utils.html_or_react_native_env_QMARK_.call(null))?level:new cljs.core.Keyword(null,"info","info",-317069002));
if(cljs.core.truth_(pred__41787.call(null,new cljs.core.Keyword(null,"warn","warn",-436710552),expr__41788))){
return ((function (pred__41787,expr__41788){
return (function (p1__41781_SHARP_){
return console.warn(p1__41781_SHARP_);
});
;})(pred__41787,expr__41788))
} else {
if(cljs.core.truth_(pred__41787.call(null,new cljs.core.Keyword(null,"debug","debug",-1608172596),expr__41788))){
return ((function (pred__41787,expr__41788){
return (function (p1__41782_SHARP_){
return console.debug(p1__41782_SHARP_);
});
;})(pred__41787,expr__41788))
} else {
if(cljs.core.truth_(pred__41787.call(null,new cljs.core.Keyword(null,"error","error",-978969032),expr__41788))){
return ((function (pred__41787,expr__41788){
return (function (p1__41783_SHARP_){
return console.error(p1__41783_SHARP_);
});
;})(pred__41787,expr__41788))
} else {
return ((function (pred__41787,expr__41788){
return (function (p1__41784_SHARP_){
return console.log(p1__41784_SHARP_);
});
;})(pred__41787,expr__41788))
}
}
...
figwheel.client.utils.eval_helper = (function figwheel$client$utils$eval_helper(code,p__41791){
...
var eval_fn = cljs.core.get.call(null,map__41792__$1,new cljs.core.Keyword(null,"eval-fn","eval-fn",-1111644294));
...
return (function (p1__41794_SHARP_){
return new_def.callback(p1__41794_SHARP_);
});})(new_def))
);
...
return (function (p__41795){
var vec__41796 = p__41795;
var ky = cljs.core.nth.call(null,vec__41796,(0),null);
var v = cljs.core.nth.call(null,vec__41796,(1),null);
...
//# sourceMappingURL=utils.js.map?rel=1526826997063
